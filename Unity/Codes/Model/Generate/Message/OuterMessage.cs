...
// 自己unitId
	...
	[ResponseType(nameof(A2C_LoginAccout))]
	...
	[Message(OuterOpcode.A2C_LoginAccout)]
	[ProtoContract]
	public partial class A2C_LoginAccout: Object, IResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ResponseType(nameof(A2C_GetSeverInfos))]
	[Message(OuterOpcode.C2A_GetSeverInfos)]
	[ProtoContract]
	public partial class C2A_GetSeverInfos: Object, IRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(OuterOpcode.A2C_GetSeverInfos)]
	[ProtoContract]
	public partial class A2C_GetSeverInfos: Object, IResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[ResponseType(nameof(A2C_DeleteAllRole))]
	[Message(OuterOpcode.C2A_DeleteAllRole)]
	[ProtoContract]
	public partial class C2A_DeleteAllRole: Object, IRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(OuterOpcode.A2C_DeleteAllRole)]
	[ProtoContract]
	public partial class A2C_DeleteAllRole: Object, IResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
